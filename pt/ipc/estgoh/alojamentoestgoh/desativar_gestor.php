...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top navGestor" id="mainNav">
 ...
 <div class="collapse navbar-collapse" id="navbarResponsive">
   ...
   <ul class="navbar-nav ml-auto ">
     ...
     <li class="nav-item">
           <a href="desativar_gestor.php?TerminarSessao=TS" class="nav-link navGestorimg formabotao" ><i class="fa fa-fw fa-sign-out"></i><?php print $terminaSessao; ?></a>
     </li>
   </ul>
 </div>
</nav>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-9">
      <div class="titulo">
        <?php print $desativaGes;?>
      </div>
	    <div class="card mb-3" style="width:800px;">
  			<div class="card-header">
  				<i class="fa fa-table"></i> <?php print $gestorAtivos;?>
        </div>
  			<div class="card-body">
    			<div class="col-md-4">
          ...
          <?php
            ...
            if(isset($_POST["pesquisa"]) && !empty($_POST["pesquisa"])){
              $Utilizadores=$dao_utilizadores->listar_utilizadores([1,$_POST["string_pesquisa"]]);
            }else{
              $Utilizadores=$dao_utilizadores->listar_utilizadores(1);
            }
            if(sizeof($Utilizadores)==0)print "Não tem gestores";
            for ($i=0; $i <sizeof($Utilizadores); $i++) {
              ...
              ');
              echo('
              <div class="modal fade" id="myModalDesativar'.$Uti->Id_Utilizador.'">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <form action="desativar_gestor.php" Method="POST">
                      <div class="modal-header divAzul">
