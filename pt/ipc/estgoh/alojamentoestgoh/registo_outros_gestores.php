	 	         ...
	 	         <li class="nav-item dropdown">
	 	           ...
	 	           <div class="dropdown-menu notificacoes" aria-labelledby="alertsDropdown">
	 	             ...
	 	             ?>
						 ...
						 <li class="nav-item">
									 <a href="registo_outros_gestores.php?TerminarSessao=TS" class="nav-link navGestorimg formabotao" ><i class="fa fa-fw fa-sign-out"></i><?php print $terminaSessao; ?></a>
						 </li>
   </ul>
 </div>
</nav>
	...
	if(isset($_POST["EditarPassword"]) && !empty($_POST["EditarPassword"])){
		if(!strcmp($_POST["password1"],$_POST["password2"])){
			...
			print('<script>
					...
					header("refresh: 1;registo_outros_gestores.php");
